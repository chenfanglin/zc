...
*/
 	...
 	*/
	function pickerRange(inputId, options) {
    /**
     * 默认配置参数数据，每个参数涵义在后解释
     */
    var defaults = {
 ...
 */
pickerRange.prototype.init = function(isCompare) {
    var __method = this;
    var minDate, maxDate;
...
pickerRange.prototype.bindChangeForSelect = function(){
	var __method = this;
	//气泡弹窗
 ...
 */
pickerRange.prototype.getSpecialPeriod = function(period){
	var __method = this;
	var date = new Date();
...
pickerRange.prototype.getCurrentDate = function(){
    return {
 ...
 */
pickerRange.prototype.removeCSS = function(isCompare, specialClass) {
    // 初始化对比时间重合部分的样式类
 ...
 * @param {String} specialClass 特殊的样式，这里默认是常规和对比日期两种样式的重合样式
 */
pickerRange.prototype.addCSS = function(isCompare, specialClass) {
 ...
 */
pickerRange.prototype.checkDateRange = function(startYmd, endYmd) {
 ...
 */
pickerRange.prototype.selectDate = function(ymd) {
 ...
 */ 
pickerRange.prototype.show = function(isCompare, __method) {
 ...
 */
pickerRange.prototype.close = function(btnSubmit) {
	var __method = this;
 ...
 * @param {Num} month 月
 */ 
pickerRange.prototype.fillDate = function(year, month, index) {
    var __method = this;
 ...
 */ 
pickerRange.prototype.str2date = function(str) {
    var ar = str.split('-');
    // 返回日期格式
 ...
 */
pickerRange.prototype.compareStrDate = function(b, e) {
 ...
 * @param {Date} d 时间
 */ 
pickerRange.prototype.date2ymd = function(d) {
 ...
 * @param {String} 日期框体ID
 */
pickerRange.prototype.changeInput = function(ipt) {
    // 强制修改为开始输入框
 ...
 */ 
pickerRange.prototype.formatDate = function(ymd) {
